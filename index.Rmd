...
The <span style="color:red">**odds**</span> would be the ratio of the probability $P(x)$ to its compliment $(1-P(x))$. Hence, the odds of being a satisfied student would be $$P(S) /(1-P(S)) = .47/.53 = .89$$
...
When observing the effect of a unit change in an explanatory variable on predicting the outcome of $Y$ we use the logit and we interpret it as the ratio of the odds of being classified in one category of the $Y$ for two different values of the $X_i$.
